                ...
                child: Column(
                  ...
                  children: [
                    ...
                    BlocBuilder<ThemeAppCubit, ThemeAppState>(
                      builder: (context, themeState) {
                        final themeCubit = context.read<ThemeAppCubit>();
                          ...
                          child: Row(
                            children: [
                              ...
                              Switch(
                                ...
                                // Active colors (when switch is ON - dark mode)
                                activeColor: ColorResources.primaryColor,
                                activeTrackColor: Colors.red,
                                // Inactive colors (when switch is OFF - light mode)
                                ...
                                // Material 3 style for better visibility
